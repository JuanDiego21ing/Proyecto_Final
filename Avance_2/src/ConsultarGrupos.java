...
public class ConsultarGrupos {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                	ConsultarGrupos window = new ConsultarGrupos();
    ...
    private void initialize() {
        ...
        JLabel lblNewLabel = new JLabel("Consultar Grupos");
        lblNewLabel.setFont(new Font("Arial Black", Font.PLAIN, 25));
        lblNewLabel.setBounds(261, 73, 247, 39);
        frame.getContentPane().add(lblNewLabel);

        JButton btnNewButton = new JButton("EDITAR GRUPO");
        btnNewButton.setForeground(new Color(255, 255, 255));
        btnNewButton.setBackground(new Color(0, 0, 255));
        btnNewButton.setBounds(64, 149, 178, 33);
        frame.getContentPane().add(btnNewButton);

        JButton btnEliminarAlumno = new JButton("ELIMINAR GRUPO");
