...
public class Modulo_Docentes {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                	Modulo_Docentes window = new Modulo_Docentes();
    ...
    private void initialize() {
        ...
        JLabel lblNewLabel = new JLabel("MODULO DOCENTES");
        ...
        lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\diego\\OneDrive\\Desktop\\profe.png"));
        ...
        btnNewButton_4.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                frame.dispose(); // Cierra la ventana actual
                ConsultarDocente consultarDocente = new ConsultarDocente();
                consultarDocente.frame.setVisible(true); // Abre la ventana ConsultarAlumnos
            }
        });
    }
