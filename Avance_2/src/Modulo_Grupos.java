...
public class Modulo_Grupos {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                	Modulo_Grupos window = new Modulo_Grupos();
    ...
    private void initialize() {
        ...
        JLabel lblNewLabel = new JLabel("MODULO GRUPOS");
        lblNewLabel.setFont(new Font("Arial Black", Font.PLAIN, 25));
        lblNewLabel.setBounds(190, 61, 260, 37);
        frame.getContentPane().add(lblNewLabel);

        JButton btnNewButton_4_1 = new JButton("CREAR GRUPO");
        ...
        btnNewButton_4_1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                crearGrupo.frame.setVisible(true); // Abre la ventana CrearAlumno
            }
        });
        ...
        lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\diego\\OneDrive\\Desktop\\grupo.png"));
        ...
        btnNewButton_4.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                frame.dispose(); // Cierra la ventana actual
                ConsultarGrupos consultarGrupo = new ConsultarGrupos();
                consultarGrupo.frame.setVisible(true); // Abre la ventana ConsultarAlumnos
            }
        });
    }
